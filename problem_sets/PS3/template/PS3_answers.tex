...
\lstinputlisting[language=R, firstline=1, lastline=8]{PS3_answers.R}

		\item Make a scatterplot of the two variables and add the regression line. 	\vspace{7cm}
\lstinputlisting[language=R, firstline=10, lastline=15]{PS3_answers.R}
\begin{figure}
	\includegraphics[width=.5]{Q1plot.pdf}
	\end{figure}
		\item Save the residuals of the model in a separate object.	\vspace{7cm}
\lstinputlisting[language=R, firstline=17, lastline=18]{PS3_answers.R}
...
\lstinputlisting[language=R, firstline=23, lastline=25]{PS3_answers.R}
		\item Make a scatterplot of the two variables and add the regression line. 	\vspace{5cm}
\lstinputlisting[language=R, firstline=27, lastline=32]{PS3_answers.R}
\begin{figure}
	\includegraphics[width=.5]{Q2plot.pdf}
	\end{figure}
		\item Save the residuals of the model in a separate object.	\vspace{5cm}
\lstinputlisting[language=R, firstline=34, lastline=35]{PS3_answers.R}
		\item Write the prediction equation.
\lstinputlisting[language=R, firstline=37, lastline=38]{PS3_answers.R}
	\end{enumerate}
...
\lstinputlisting[language=R, firstline=40, lastline=42]{PS3_answers.R}
			\vspace{5cm}
		\item Make a scatterplot of the two variables and add the regression line. 
\lstinputlisting[language=R, firstline=44, lastline=49]{PS3_answers.R}
\begin{figure}
	\includegraphics[width=.5]{Q3plot.pdf}
\end{figure}
			\vspace{5cm}
		\item Write the prediction equation.
\lstinputlisting[language=R, firstline=51, lastline=52]{PS3_answers.R}
	\end{enumerate}
