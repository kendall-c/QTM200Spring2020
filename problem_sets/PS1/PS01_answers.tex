...
\lstinputlisting[language=R, firstline=61, lastline=68]{PS1_answers.R}
...
\lstinputlisting[language=R, firstline=72, lastline=80]{PS1_answers.R}
...
\vspace{.5cm}
\begin{itemize}
\lstinputlisting[language=R, firstline=82, lastline=83]{PS1_answers.R}
...
\lstinputlisting[language=R, firstline=85, lastline=95]{PS1_answers.R}
...
\lstinputlisting[language=R, firstline=97, lastline=107]{PS1_answers.R}

\item
Please plot the relationship between \emph{Y} and \emph{X1}? Describe this graph and the relationship. Reproduce the above graph including one more variable \emph{Region} and display different regions with different types of symbols and colors.

\lstinputlisting[language=R, firstline=109, lastline=117]{PS1_answers.R}
