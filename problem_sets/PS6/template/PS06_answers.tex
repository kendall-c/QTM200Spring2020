...
\lstinputlisting[language=R, firstline=48, lastline=61]{PS06_answers.R}
...
\lstinputlisting[language=R, firstline=67, lastline=68]{PS06_answers.R}
...
\lstinputlisting[language=R, firstline=73, lastline=74]{PS06_answers.R}
		
		What is the estimated probability of a woman with a fat intake of 100 grams per day being in the high cholesterol group? 
		\item
		
\lstinputlisting[language=R, firstline=79, lastline=81]{PS06_answers.R}		
...
\lstinputlisting[language=R, firstline=86, lastline=93]{PS06_answers.R}
...
\lstinputlisting[language=R, firstline=99, lastline=99]{PS06_answers.R}
\lstinputlisting[language=R, firstline=104, lastline=114]{PS06_answers.R}
	
	\item Construct and interpret an ordered multinomial logit with \texttt{GDPWdiff} as the outcome variable, including the estimated cutoff points and coefficients.

\lstinputlisting[language=R, firstline=116, lastline=122]{PS06_answers.R}
